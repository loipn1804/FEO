package com.vng.android.slidingmenu.lib.app;
...
import com.vng.android.slidingmenu.lib.SlidingMenu.OnCloseListener;
...
public class SlidingActivityHelper {
    ...
    private OnCloseListener closedListener;

    private OnOpenListener openedListener;
     ...
     */
    public SlidingActivityHelper(Activity activity, OnOpenListener openLis,
                                 OnCloseListener closeLis) {
        mActivity = activity;
        closedListener = closeLis;
        openedListener = openLis;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSlidingMenu.setOnOpenListener(openedListener);
        mSlidingMenu.setOnCloseListener(closedListener);
    }
