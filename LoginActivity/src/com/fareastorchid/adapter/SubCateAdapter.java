...
public class SubCateAdapter extends BaseAdapter {
    ...
    private List<CateType> listCates;

    private OnFloristListener listener;

    public SubCateAdapter(Context context) {
        super();
    ...
    public List<CateType> getListCates() {
        return listCates;
    }

    public void setListCates(List<CateType> listCates) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            if (listCates != null && position >= 0
                ...
                final CateType cate = listCates.get(position);
                if (cate != null) {
