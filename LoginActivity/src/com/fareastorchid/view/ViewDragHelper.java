...
public class ViewDragHelper {
     ...
     *
     * @param forParent   Parent view to monitor
     * @param sensitivity Multiplier for how sensitive the helper should be about
    ...
    private int computeSettleDuration(View child, int dx, int dy, int xvel, int yvel) {
        Log.i("ThuanPQ", "mMinVelocity: " + mMinVelocity);
        Log.i("ThuanPQ", "mMaxVelocity: " + mMaxVelocity);
        mMinVelocity = 0;
        mMaxVelocity = 16000;
    ...
    private boolean checkNewEdgeDrag(float delta, float odelta, int pointerId, int edge) {
        ...
        if ((mInitialEdgesTouched[pointerId] & edge) != edge || (mTrackingEdges & edge) == 0 || (mEdgeDragsLocked[pointerId] & edge) == edge || (mEdgeDragsInProgress[pointerId] & edge) == edge
