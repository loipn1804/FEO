...
public class SlidingUpPanelLayout extends ViewGroup {
     ...
     *
     * @param anchorPoint A value between 0 and 1, determining the position of the
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mFirstLayout) {
            Log.i("ThuanPQ", "onLayout  header Height: " + getChildAt(0).getHeight());
            mPanelHeight = getHeight() - getChildAt(0).getHeight();
    ...
    private boolean isDragViewUnder(int x, int y) {
        ...
        return screenX >= viewLocation[0] && screenX < viewLocation[0] + mDragView.getWidth() && screenY >= viewLocation[1] && screenY < viewLocation[1] + mDragView.getHeight();
    }
    ...
    public interface PanelSlideListener {
         ...
         * @param slideOffset The new offset of this sliding pane within its range, from
         *                    0-1
         */
